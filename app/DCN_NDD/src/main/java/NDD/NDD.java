...
public class NDD {
    ...
    public static HashMap<Pair<NDD, NDD>, NDD> AndCache = new HashMap<>();
    public static HashMap<Pair<NDD, NDD>, NDD> OrCache = new HashMap<>();
    public static HashMap<Pair<NDD, Integer>, NDD> ExistCache = new HashMap<>();
    ...
    private static NDD ANDRec(NDD a, NDD b) {
        ...
        if (a == b)
            return a;
        if (useCache) {
            NDD ret = AndCache.get(new Pair<NDD, NDD>(a, b));
            if (ret != null)
                return ret;
            ret = AndCache.get(new Pair<NDD, NDD>(a, b));
            if (ret != null)
                return ret;
        }
        if (a.field == b.field) {
            ...
            if (useCache) {
                AndCache.put(new Pair<NDD, NDD>(a, b), ret);
            }
            return ret;
        } else {
            if (a.field > b.field) {
    ...
    private static NDD ORRec(NDD a, NDD b) {
        ...
        if (a == b)
            return a;
        if (useCache) {
            NDD ret = OrCache.get(new Pair<NDD, NDD>(a, b));
            if (ret != null)
                return ret;
            ret = OrCache.get(new Pair<NDD, NDD>(a, b));
            if (ret != null)
                return ret;
        }
        if (a.field == b.field) {
            ...
            while (itera.hasNext()) {
                ...
                while (iterb.hasNext()) {
                    ...
                    temp_a.put(entrya.getKey(), bdd.ref(bdd.and(t, n)));
                    // if(test)System.out.println("tag4");
                    bdd.deref(t);
                    t = temp_b.get(entryb.getKey());
                    // if(test)System.out.println("tag5");
                    temp_b.put(entryb.getKey(), bdd.ref(bdd.and(t, n)));
            ...
            NDD ret = table.mk(a.field, tempSet);
            if (useCache) {
                OrCache.put(new Pair<NDD, NDD>(a, b), ret);
            }
            return ret;
        } else {
            if (a.field > b.field) {
    ...
    private static NDD ExistRec(NDD a, int field) {
        ...
        if (useCache) {
            NDD ret = ExistCache.get(new Pair<NDD, Integer>(a, field));
            if (ret != null)
                return ret;
        }
        if (a.field == field) {
            ...
            for (NDD next : a.edges.keySet()) {
                if (sum == null) {
                    ...
                    sum = NDD.OR(sum, next);
                    if (old != sum)
                        table.testAndDelete1(old);
                }
            }
            if (useCache) {
                ExistCache.put(new Pair<NDD, Integer>(a, field), sum);
            }
            return sum;
        } else {
            HashMap<NDD, Integer> tempSet = new HashMap<NDD, Integer>();
            ...
            NDD ret = table.mk(a.field, tempSet);
            if (useCache) {
                ExistCache.put(new Pair<NDD, Integer>(a, field), ret);
            }
            return ret;
        }
    }
